...
mod.bestvars <- glm(p12switch ~ pvote08 + ideo.diff.repub + pid3_12 + CC12_321 + CC12_302 + CC12_322_3 + partyreg12_1 + religpew_12_2, binomial, predict.CCES)
...
maya2 <- tibble(pvote08 = 1, ideo.diff.repub = 4, pid3_12 = 2, CC12_321 = 1, CC12_302 = 1, CC12_322_3 = 2, partyreg12_1 = 0, religpew_12_2 = 0)
...
```{r}
model.accuracy <- 100 - sum(abs(mod.all.check$bi.resid))/nrow(mod.all.check)

model.accuracy.bestvars <- 100 - sum(abs(mod.bestvars.check$bi.resid))/nrow(mod.bestvars.check)

mod.all.check.switch <- mod.all.check %>%
  filter(p12switch == 1)
