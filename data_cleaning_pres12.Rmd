...
mod1 <- glm(p12switch ~ gender_12 + age12 + ideo5_12 + pid3_12, binomial, cces.test)

summary(mod1)

mod2 <- glm(p12switch ~ gender_12 + age12 + ideo5_12 + pid3_12, binomial, CCES_Panel.reg)

summary(mod2)

# creating a person and testing predict
maya <- tibble(gender_12 = 0, age12 = 38, ideo5_12 = 2, pid3_12 = 1)
