...
```{r policy and public opinion plots for switchers}
...
# Modeling and predicting - demographics

mod.demo <- glm(p12switch ~ gender_12 + age12 + race_12_char + religpew_12_char + pid3_12 + partyreg12.char + income12 + educ_12, binomial, predict.CCES)

summary(mod.demo)

# creating a person and testing predict

maya1 <- tibble(gender_12 = 0, age12 = 38, pid3_12 = 2, race_12_char = "white", income12 = 3, partyreg12.char = "democrat", educ_12 = 6, religpew_12_char = "Jewish")

predict(mod.demo, newdata = maya1)

augment(mod.demo, newdata = maya1)

plogis(predict(mod.demo, newdata = maya1))

# most significant factors seem to be: pid3_12, educ_12, partyreg12.char,
# race_12_char, age12

# modeling and predicting - all variables

mod.all <- glm(p12switch ~  age12 + CC12_302 + CC12_303d + CC12_308a + CC12_320 + CC12_321 + CC12_322_1 + CC12_322_2 + CC12_322_3 + CC12_322_4 + CC12_322_5 + CC12_322_6 + CC12_324 + CC12_325 + CC12_326 + CC12_327 + CC12_328 + CC12_329 + CC12_341A + CC12_341C + CC12_341D + CC12_341E + CC12_341F + CC12_387_1 + CC12_387_2 + CC12_387_3 + CC12_387_4 + CC12_387_5 + CC12_387_6 + CC12_387_7 + CC12_387_8 + CC12_387_9 + CC12_387_10 + CC12_387_11 + CC12_387_12  + CC12_387_13 + CC12_422a + CC12_422b + CC12_423aa + CC12_423bb + educ_12 +  gender_12 + ideo5_12 + income12 + partyreg12.char + pew_prayer_12 + pid3_12 + pvote08 + pvote12 + race_12_char + religpew_12_char + ideo.diff.repub + ideo.diff.dem + ideo.diff.romney + ideo.diff.obama, binomial, predict.CCES)
...
mod.docvisit <- glm(p12switch ~ CC12_387_1, binomial, data = predict.CCES)
...
# demographics variables: age12, educ_12, gender_12, ideo5_12, income12, partyreg12.char
# pew_prayer_12, pid3_12, pid7_12, pvote08, pvote12, race_12_char, religpew_12

# policy position/public opinion/approval variables: CC12_302, CC12_303d, CC12_308a,
# CC12_320, CC12_321, CC12_322_1:CC12_322_6, CC12_324, CC12_325, CC12_326, CC12_327,
# CC12_328, CC12_329, CC12_341A, 

# life events: CC12_387_1: CC12_387_13 (ADD CC12_387_2:CC12_387_9 TO PREDICT.CCES)


# Pr(>|z|), .001: pvote 08, ideo.diff.repub, pid3_12, CC12_321
# Pr(>|z|), .01: CC12_302, CC12_322_3
# Pr(>|z|), .05: partyreg12.char, religpew_12, CC12_322_4
```
...
diff.lifeevents %>%
  ggplot(aes(diff, name)) + geom_point() + labs(title = "How Switchers and the Electorate Differ", subtitle = "Experiences within the last 2 years", x = "Percentage Point Difference between Electorate and Switchers", y = "Life Event") + theme_minimal() + scale_x_continuous(limits = c(-10, 10)) + scale_y_discrete(label = c("Better job", "Been victim of a crime", "Employee benefits cut", "Visited doctor's office", "Visited emergency room", "Loss of job", "Child moved out", "New child in family", "Divorce", "Marriage", "Promotion at work", "Raise at work", "Traffic ticket"))
```

```{r testing best vars model, echo = FALSE}

# model and predict with best variables

mod.bestvars <- glm(p12switch ~ pvote08 + ideo.diff.repub + pid3_12 + CC12_321 + CC12_302 + CC12_322_3 + partyreg12_1 + religpew_12_2 + CC12_387_1, binomial, predict.CCES)
...
maya2 <- tibble(pvote08 = 1, ideo.diff.repub = 4, pid3_12 = 2, CC12_321 = 1, CC12_302 = 1, CC12_322_3 = 2, partyreg12_1 = 0, religpew_12_2 = 0, CC12_387_1 = 1)

plogis(predict(mod.bestvars, newdata = maya2))
```

```{r}

mod.voteandideo <- glm(p12switch ~ pvote08 + race_12_2, binomial, predict.CCES)

mod.voteandideo %>% tidy() %>% select(term, estimate, std.error, p.value) %>% arrange(p.value)
```


```{r checking model, echo = FALSE}
...
model.accuracy.bestvars <- 100 - sum(abs(mod.bestvars.check$bi.resid))/nrow(mod.bestvars.check)

model.bestvars.check.switch <- mod.bestvars.check %>% filter(p12switch == 1)

# both models tend to predict no switching when switching does indeed occur.
```

```{r plotting status, echo = FALSE}
